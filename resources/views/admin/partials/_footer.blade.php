...
<!--JS-->
<!-- jQuery 3-->
<script src="{{asset('administrator/dist/libs/jQuery/jquery.min.js')}}"></script>
<!-- Bootstrap 3.3.7-->
<script src="{{asset('administrator/dist/libs/bootstrap/dist/js/bootstrap.min.js')}}"></script>
<!-- jquery-ui-->
<script src="{{asset('administrator/dist/libs/datepicker/jquery-ui.js')}}"></script>
<script src="{{asset('administrator/dist/libs/datepicker/bootstrap-datepicker.min.js')}}"></script>
<!-- Slimscroll-->
<script src="{{asset('administrator/dist/libs/jquery-slimscroll/jquery.slimscroll.min.js')}}"></script>
<!-- FastClick-->
<script src="{{asset('administrator/dist/libs/fastclick/lib/fastclick.js')}}"></script>
<!-- AdminLTE App-->
<script src="{{asset('administrator/dist/libs/adminlte/adminlte.min.js')}}"></script>
...
<script src="{{asset('administrator/dist/js/script.js')}}"></script>
@yield('js')