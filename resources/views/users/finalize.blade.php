	...
	<div class="row" style="margin-bottom: 30px;">
		<form action="" method="get">
			...
			<div style="text-align: left; color: red">
				<b>Tổng: {{ $medical_bills->total()}} bệnh nhân</b>
			</div>	
		</form>
	</div>
</div>
				...
				<tr class="main">
					...
					<td style="padding: 5px;">
						<div class="float-right tooltip-right">
							...
							<a data-placement="bottom" data-toggle="tooltip" title="Xem chỉ định" class="float-left" style="color: #2f4358;" href="{{ route('get.description.view', ['accession_number' => $medical_bill->accession_number]) }}"><i class="fas fa-notes-medical fa-lg" style="color: blue;"></i></a>        
							@endif
						</div>
					</td>
				</tr>
