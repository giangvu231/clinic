...
<div class="container">
	<div class="row">
		...
		<form style="width: 100%" action="<?php echo e(route('post.reorder.store')); ?>" method="POST">
					...
					<td  colspan="2" width="50%" style="vertical-align: top;">
						<table border="0" width="100%" style="text-align: center;">
							<tr>
								...
								<td><input type="text" name="patient_id" class="form-control" autocomplete="off" placeholder="" value="<?php echo e($medical_bill->patient_id); ?>">
								</td>
							</tr>
							<tr>
								<td style="font-weight: bold;">ACC<span class="important-infor">*</span></td>
								<td><input type="text" name="accession_number" class="form-control" autocomplete="off" placeholder="" value="<?php echo e($medical_bill->accession_number); ?>">
								</td>
							...
							<tr>
								...
								<td><input type="text" name="first_name" class="form-control" autocomplete="off" placeholder="" required="" value="<?php echo e($medical_bill->first_name); ?>"></td>
							</tr>
							<tr>
								<td style="font-weight: bold;">Ngày sinh</td>
								<td><input type="date" name="birth_date" class="form-control" autocomplete="off" placeholder=""  value="<?php echo e($medical_bill->birth_date); ?>" ></td>
							</tr>
							<tr>
								<td style="font-weight: bold;">Giới tính </td>
								<td>
									<select class="form-control" name="sex">
										<option value="<?php echo e($medical_bill->sex); ?>"></option>
					...
					<td colspan="2" width="50%" style="vertical-align: top;">
						<table style="text-align: center;" border="0" width="100%">
							...
							<tr>
								...
								<td><input type="text" name="address" class="form-control" autocomplete="off" placeholder="" value="<?php echo e($medical_bill->address); ?>"></td>
							</tr>
							<tr>
								<td style="font-weight: bold;">Triệu chứng<span class="important-infor">*</span></td>
								<td><input type="text" name="reason" class="form-control" autocomplete="off" placeholder="" required="" value="<?php echo e($medical_bill->reason); ?>"></td>
							</tr>
							<tr>
							...
							<tr hidden="">
								...
								<td><input type="datetime" name="ngay_vao" class="form-control" autocomplete="off" placeholder="" required="" value="<?php echo e($medical_bill->schedule_date); ?>"></td>
							</tr>
