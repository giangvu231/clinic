        ...
        <div class="account-permiss__content">
            <form action="<?php echo e(route('admin.template.update', ['id'=>$template->TuDienKetQua_Id])); ?>" method="POST" id="update-form">
                ...
                <div class="form-group">
                    ...
                    <div class="edit-input">
                        <label>Mô tả</label>
                        <textarea class="form-control" name="KetQua_Text" id="summernote" cols="10" rows="10" style="float:left; width: 500px"><?php echo e($template->KetQua_Text); ?></textarea>
                        <div class="clear-fix"></div>
                    </div>
                     <div class="edit-input">
                        <label>Kết Luận</label>
                        <input class="form-control" value="<?php echo e($template->KetLuan); ?>" name="KetLuan" style="float:left; width: 500px" />
                        <div class="clear-fix"></div>
                    </div>
                    <div class="edit-input">
