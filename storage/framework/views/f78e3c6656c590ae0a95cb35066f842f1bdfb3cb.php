...
<link rel="stylesheet" type="text/css"
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('dist/style.css')); ?>"/>
</head>
<body>
<div id="wrapper">
        ...
        <div class="container">
            <div class="chang-pass__wrap">
                ...
                <div class="chang-pass--form">
                    <form action="<?php echo e(route('post.user.changepass')); ?>" method="POST" id="change-password-form">
                        ...
                        <div class="chang-pass--btn">
                            ...
                            <button class="btn-cancel fleft" type="button"><a href="<?php echo e(URL::previous()); ?>">Hủy bỏ</a></button>
