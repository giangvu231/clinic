    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" id="control-sidebar-settings-tab">
            <form method="post">
                ...
                <!-- /.form-group-->
                <div class="form-group">
                    <label class="control-sidebar-subheading">Delete chat history<a class="text-red pull-right"
...
<!--JS-->
<!-- jQuery 3-->
<script src="<?php echo e(asset('administrator/dist/libs/jQuery/jquery.min.js')); ?>"></script>
<!-- Bootstrap 3.3.7-->
<script src="<?php echo e(asset('administrator/dist/libs/bootstrap/dist/js/bootstrap.min.js')); ?>"></script>
<!-- jquery-ui-->
<script src="<?php echo e(asset('administrator/dist/libs/datepicker/jquery-ui.js')); ?>"></script>
<script src="<?php echo e(asset('administrator/dist/libs/datepicker/bootstrap-datepicker.min.js')); ?>"></script>
<!-- Slimscroll-->
<script src="<?php echo e(asset('administrator/dist/libs/jquery-slimscroll/jquery.slimscroll.min.js')); ?>"></script>
<!-- FastClick-->
<script src="<?php echo e(asset('administrator/dist/libs/fastclick/lib/fastclick.js')); ?>"></script>
<!-- AdminLTE App-->
<script src="<?php echo e(asset('administrator/dist/libs/adminlte/adminlte.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('administrator/dist/js/script.js')); ?>"></script>
