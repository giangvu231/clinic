...
<div class="container">
	<div class="row">
		<table border="0" width="100%" style="margin-bottom: 30px;">
			<tr>
				<td width="50%" style="text-align: left; font-size: 30px; font-weight: bold;">Bệnh nhân đang chờ chụp chiếu</td>
				<td width="30%">
					<div class="input-group">
						...
						<select name="limit" class="form-control" onchange="location = this.value">
							...
							<option value="<?php echo e(route('get.schedule.view', ['limit' => 10])); ?>">10</option>
							<option value="<?php echo e(route('get.schedule.view', ['limit' => 20])); ?>">20</option>
							<option value="<?php echo e(route('get.schedule.view', ['limit' => 50])); ?>">50</option>
							<option value="<?php echo e(route('get.schedule.view', ['limit' => 100])); ?>">100</option>
						</select>
					</div>
				</td>
				<td style="text-align: right;">
					Tổng: <?php echo e($medical_bills->total()); ?> bệnh nhân
				</td>
			</tr>
		</table>
	</div>
	...
	<div class="row" style="margin-bottom: 30px;">
		<form action="" method="get">
			...
			<table border="0" width="100%" style="line-height: 50px;">
				<tr>
					<td><input type="text" placeholder="Nhập mã bệnh nhân" class="input_data form-control" name="patient_id" value="<?php echo e(request()->patient_id); ?>" style="width: 93%;" autocomplete="off"></td>
					<td><input type="text" placeholder="Nhập tên bệnh nhân" class="input_data form-control" name="patient_name" value="<?php echo e(request()->patient_name); ?>" style="width: 93%;" autocomplete="off"></td>
					<td><input type="text" name="access_id" placeholder="Nhập mã chỉ định" class="input_data form-control" value="<?php echo e(request()->access_id); ?>"  style="width: 93%;"></td>
				...
				<tr>
					<td>
						<div class="input-group">
							...
							<input style="width: 90%;" type="date" name="date_from" id="from" class="from datepicker input_data form-control" placeholder="yyyy-mm-dd" value="<?php echo e(request()->date_from); ?>"/>
						</div>
					</td>
					<td>
						<div class="input-group">
							<span class="input-group-addon">Đến ngày</span> 
							<input style="width: 90%;" type="date" name="date_to" id="to" class="to input_data form-control" placeholder="yyyy-mm-dd" value="<?php echo e(request()->date_to); ?>"/>
						</div>
					</td>
					<td>
						<div class="input-group">
							...
							<select id="select-beast" class="form-control" class="demo-default" placeholder="Tên mẫu...." name="ten_thiet_bi" style="width: 90%">
								...
								<?php $__currentLoopData = $loai_thiet_bi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loai): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<option value="<?php echo e($loai->loai_thiet_bi); ?>" <?php echo e((request()->ten_thiet_bi == $loai->loai_thiet_bi) ? 'selected' : ""); ?>><?php echo e($loai->loai_thiet_bi); ?></option>
				...
				<tr class="main">
					...
					<td style="padding: 5px;">
						<div class="float-right tooltip-right">
							...
							<a data-placement="bottom" data-toggle="tooltip" title="Xem chỉ định" class="float-left" style="color: #2f4358;" href="<?php echo e(route('get.image.view', ['accession_number' => $medical_bill->accession_number])); ?>"><i class="fas fa-notes-medical fa-lg" style="color: #00BD9C;"></i></a>
							<?php else: ?>
							<a data-placement="bottom" data-toggle="tooltip" title="Chuyển tiếp" class="float-left" style="color: #2f4358;" href="<?php echo e(route('get.radiologist.update_status', $medical_bill->id)); ?>"><i class="fas fa-arrow-alt-circle-right fa-lg" style="color: #00BD9C;"></i></a>         
							<?php endif; ?>
						</div>
					</td>
				</tr>
