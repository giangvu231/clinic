				...
				<tr>
					...
					<td>
						...
						<select name="limit" class="form-control" onchange="location = this.value">
							...
							<option value="<?php echo e(route('get.reporting.view', ['limit' => 10])); ?>">10</option>
							<option value="<?php echo e(route('get.reporting.view', ['limit' => 20])); ?>">20</option>
							<option value="<?php echo e(route('get.reporting.view', ['limit' => 50])); ?>">50</option>
							<option value="<?php echo e(route('get.reporting.view', ['limit' => 100])); ?>">100</option>
						</select>
					</div>
	...
	<div class="row">
		<table width="100%" border="0" style="vertical-align: middle; text-align: center; border-collapse: collapse; margin-bottom: 15px;">
			...
			<tbody>
				...
				<tr ondblclick="window.location.href = '<?php echo e(route('get.description.view', ['accession_number' => $medical_bill->accession_number])); ?>';" class="main" id="view-radiologist">
					...
					<td>
						<div name="device_name"><?php echo e($medical_bill->reason); ?></div>
					</td>
<!-- 					<td>
						<input type="checkbox" id="choose" name="choose" value="<?php echo e($medical_bill->accession_number); ?>">
					</td> -->					
